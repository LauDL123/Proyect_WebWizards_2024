...
if (isset($_GET['id'])) {
    ...
    // Actualizar el estado del pedido a "Tomado" (estado = 2)
    if (actualizar_estado_pedido($id_pedido, 2)) {
        // Enviar un correo al cliente notificando que su pedido ha sido tomado
        ...
        if ($resultado->num_rows > 0) {
            ...
            try {
                ...
                $mail->send();
                echo '<script>alert("Pedido tomado con éxito y correo enviado al cliente."); window.location.href = "../gestionar_pedidos.php";</script>';
            } catch (Exception $e) {
